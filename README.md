...
Для доступного оборудования и оборудования на обслуживании в списке доступна
ссылка «Редактировать». На отдельной странице можно исправить инвентарный номер
и тип. Выданные и списанные предметы не редактируются.
