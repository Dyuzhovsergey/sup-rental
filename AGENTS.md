...
Сохраняй серверный рендеринг через Go `html/template`, обычный HTML, простой CSS
и минимальное количество JavaScript.
...
Общие улучшения внешнего вида остаются отдельным этапом развития интерфейса.
На текущих этапах браузерная приёмка проверяет работоспособность и базовую
понятность добавленной пользовательской функции.
