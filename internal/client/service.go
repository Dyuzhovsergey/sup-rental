...
// PageSize задаёт фиксированное количество клиентов на странице списка.
const PageSize = 10

var (
	// ErrInvalidPage означает некорректный номер страницы клиентов.
...
func (s *Service) ListPage(ctx context.Context, page int) (Page, error) {
	if page <= 0 {
