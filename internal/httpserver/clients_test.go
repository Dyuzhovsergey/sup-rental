...
func newClientTestHandler(t *testing.T, clients clientService, role user.Role) http.Handler {
	...
	handler, err := NewHandler(discardLogger(), &equipmentServiceStub{}, &authServiceStub{}, resolver, &operatorServiceStub{}, &auditServiceStub{}, clients, &rentalServiceStub{}, &adminDashboardServiceStub{}, CookieSettings{})
	if err != nil {
